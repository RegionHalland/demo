		...
		<div class="w-full mx-auto">
			<div class="flex flex-wrap -mx-4">
				<div class="w-full md:w-8/12 px-4">
					...
					@php($archive_posts = get_region_halland_news_archive_taxonomi_category_filter())	
				...
				<div class="w-full md:w-4/12 px-4 mt-12 md:mt-0">
					...
					<ul class="list-reset">
						@php($categories = get_region_halland_news_archive_taxonomi_category_categories())
						<li><a href="{{ get_post_type_archive_link(get_post_type()) }} }}" class="px-2 mb-2 py-1 text-sm no-underline hover:underline focus:underline text-black bg-grey-lightest rounded-full inline-block">Visa alla nyheter</a></li>
